...
function paintDOM(pastEvents){
    ...
    const tagToUpdate = document.getElementById("cards-past")
    console.log("tagToUpdate", tagToUpdate)

    for (let i = 0; i < pastEvents.length; i++) {
        body += `
        <div class="card" style="width: 18rem;">
                <img src="${pastEvents[i].image}" class="card-img-top" alt="${pastEvents[i].name}">
                <div class="card-body">
                <h4 class="card-text">${pastEvents[i].name}</h1>
